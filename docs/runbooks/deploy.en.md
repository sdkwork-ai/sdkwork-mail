# Runbook — sdkwork-mail deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-mail-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-mail/bundle`, loads the image, starts
